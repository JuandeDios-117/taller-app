...
// 12. REINICIAR SEMANA (FACTURAS A 0, PUNTOS INTACTOS)
...
app.post('/api/facturas', async (req, res) => {
    ...
    try {
        ...
        // Sumar puntos automáticos (1 punto por cada $5,000 vendidos)
...
app.post('/api/recompensas/canjear', async (req, res) => {
    ...
    if (!costo) return res.status(400).json({ error: "Producto inválido." });
